...
-- changeset karybekov:9
ALTER TABLE message_text DROP COLUMN IF EXISTS text;
ALTER TABLE message_text ADD COLUMN IF NOT EXISTS text TEXT;

-- changeset karybekov:10
ALTER TABLE message_text
ALTER COLUMN command_name TYPE VARCHAR(100),
